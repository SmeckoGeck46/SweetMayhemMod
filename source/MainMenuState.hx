...
class MainMenuState extends MusicBeatState {
	...
	public static var firstStart:Bool = true; //taken from Kade Engine lol
	public static var finishedFunnyMove:Bool = false; //taken from Kade Engine lol
	...
	override function create() {
		...
		// ok, if you can't flipping code, then learn how to code
		...
		switch (FlxG.save.name) {
			...
			case "save2":
				usingSave.text = "sweet mayhem";
			case "save3":
				usingSave.text = "balthazar";
			case "save4":
				usingSave.text = "eemmet";
			case "save5":
				usingSave.text = "wyldstyle";
			case "save6":
				usingSave.text = "benny";
			case "save7":
				usingSave.text = "rex dangervest";
			case "save8":
				usingSave.text = "larry poppins";
			case "save9":
				usingSave.text = "zane";
		}
	...
	override function update(elapsed:Float) {
		...
		if (!selectedSomethin) {
			if (controls.UP_MENU) {
				FlxG.sound.play('assets/sounds/custom_menu_sounds/' + menuSoundJson.customMenuScroll + '/scrollMenu' + TitleState.soundExt);
				changeItem(-1);
			}
			...
			if (controls.ACCEPT) {
				if (optionShit[curSelected] == 'donate') {
					...
					FlxG.sound.play('assets/sounds/custom_menu_sounds/' + menuSoundJson.customMenuConfirm + '/confirmMenu' + TitleState.soundExt);
