		...
		if (isMenuItem)
		{
			...
			switch (itemType) {
				...
				case "C-Shape":
					...
					x = FlxMath.lerp(x - 26, Math.exp(scaledY * 0.8) * 70 + (FlxG.width * 0.1), 0.16 / (CoolUtil.fps / 60));
					if (scaledY < 0)
	...
	public function createSymbol(letter:String) {
		switch (letter)
		{
			...
			case ",":
				...
				animation.play(letter);
			case "\\":
				animation.addByPrefix(letter, 'bs0', 24);
				animation.play(letter);
			case "\"":
				animation.addByPrefix(letter, 'quote0', 24);
				animation.play(letter);
			case "/":
				animation.addByPrefix(letter, 'fs0', 24);
				animation.play(letter);
			case "da":
				animation.addByPrefix(letter, 'down arrow0', 24);
				animation.play(letter);
			case "ua":
				animation.addByPrefix(letter, 'up arrow0', 24);
				animation.play(letter);
			case "la":
				animation.addByPrefix(letter, 'left arrow0', 24);
				animation.play(letter);
			case "heart":
				animation.addByPrefix(letter, 'heart0', 24);
				animation.play(letter);
			case "ra":
				animation.addByPrefix(letter, 'right arrow0', 24);
				animation.play(letter);
			default:
