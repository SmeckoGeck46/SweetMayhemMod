...
class SaveDataState extends MusicBeatState {
	...
	override function create(){
		...
		var menuBG:FlxSprite = new FlxSprite().loadGraphic('assets/images/menuDesat.png');
			optionList = [
							{name: "Change Controls", value: false, intName:'controls', desc:"Edit bindings!", ignore: true,},
							{name: "Always Show Cutscenes", intName: "alwaysDoCutscenes", value: false, desc: "Force show cutscenes, even in freeplay"},
							{name: "Ghost Tapping", value: false, intName: "useCustomInput", desc: "Turn this on if you want to use the keyboard without losing health. Helps make the game slightly easier."},
							...
							{name: "Alternate Vocals", value: false, intName: "stressTankmen", desc: "Changes the vocals to be either alternate voices or funny voices."}, //this is the funny voices option but with a different name
							...
							{name: "Sound Test...", value: false, intName: 'soundtest', desc: "This does nothing. All it does now is be a nut button.", ignore: true},
							...
							/*{name: "nut button", value: false, intName:'newassets', desc: "nut button", ignore: true,}, //replaced the Module State thingy with a nut button lol
							{name: "UI Layout...", value: false, intName:'newui', desc: "Change the layout of the UI in-game!", ignore: true,},*/
							{name:"New Character...", value: false, intName:'newchar', desc: "This does nothing. All it does now is be a nut button.", ignore: true},
							{name:"New Stage...", value:false, intName:'newstage', desc: "This does nothing. All it does now is be a nut button.", ignore: true},
							{name: "New Song...", value: false, intName:'newsong', desc: "This does nothing. All it does now is be a nut button.", ignore: true},
							{name: "New Week...", value: false, intName: 'newweek', desc: "This does nothing. All it does now is be a nut button.", ignore: true},
							{name: "Sort...", value: false, intName: 'sort', desc: "This does nothing. All it does now is be a nut button.", ignore : true}
							#end
						];
			...
			if (saves.members[curSelected].beingSelected) {
				if (!saves.members[curSelected].askingToConfirm) {
					if (saves.members[curSelected].selectingLoad) {
						...
						FlxG.save.bind(saveName, "SmeckoGeck/MayhemMod");
						...
						FlxG.camera.flash(0xafffffff, 0.5);
						// don't edit the djkf
					...
					FlxG.save.erase();
					saves.members[curSelected].askToConfirm(false);
					FlxG.camera.flash(0xaf930000, 0.5);
					...
					FlxG.save.data.songScores = ["tutorial" => 0];
					FlxG.save.bind(oldSave, "SmeckoGeck/MayhemMod");
					Highscore.load();
				}
				...
				switch (optionList[optionsSelected].name) {
					case "New Character...": FlxG.sound.play('assets/sounds/freshIntro' + TitleState.soundExt);
					case "New Song...": FlxG.sound.play('assets/sounds/freshIntro' + TitleState.soundExt);
					case "New Stage...": FlxG.sound.play('assets/sounds/freshIntro' + TitleState.soundExt);
					case "New Week...": FlxG.sound.play('assets/sounds/freshIntro' + TitleState.soundExt);
					case "Sort...": FlxG.sound.play('assets/sounds/freshIntro' + TitleState.soundExt);
					case "Sound Test...": FlxG.sound.play('assets/sounds/freshIntro' + TitleState.soundExt);
